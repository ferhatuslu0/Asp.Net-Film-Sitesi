<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="encokizlenenler.aspx.cs" Inherits="encokizlenenler" %>
    ...
    <li><a href="iletisim.aspx" class="myButton">İletişim</a></li>
     ...
     <div id="orta">
        <div class="filmTasiyici">
            ...
            <asp:SqlDataSource ID="EncokizlenenlerSqlDataSource" runat="server"
                ConnectionString="<%$ ConnectionStrings:BaglamaCumlesi %>"
                ProviderName="<%$ ConnectionStrings:BaglamaCumlesi.ProviderName %>"
                SelectCommand="SELECT TOP 20 [filmId], [filmAd], [filmBilgi], [FilmUrl], [filmTuru] FROM [Filmler] WHERE ([filmTuru] = 'encokizlenen')"></asp:SqlDataSource>
            <asp:Repeater ID="EncokizlenenlerRepeater" runat="server" DataSourceID="EncokizlenenlerSqlDataSource">
                <ItemTemplate>
                    <div class="ic_bolme">
                ...
                <FooterTemplate>
                        <asp:Label ID="lblfilm" runat="server" CssClass="filmYok" Text  ="Aradığınız Film Bulunamadı Sitede Görmek İstediğiniz Filmi İletişim Kısmından İletiniz" Visible="<%#EncokizlenenlerRepeater.Items.Count==0 %>"></asp:Label>
                  </FooterTemplate>
