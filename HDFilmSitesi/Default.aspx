...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="orta">
        <div class="filmlerTasiyici">
            ...
            <asp:SqlDataSource ID="DefaultSqlDataSource" runat="server"
                ConnectionString="<%$ ConnectionStrings:BaglamaCumlesi %>"
                ProviderName="<%$ ConnectionStrings:BaglamaCumlesi.ProviderName %>"
                SelectCommand="SELECT TOP 20 [filmId], [filmAd], [filmBilgi], [FilmUrl], [filmTuru] FROM [Filmler] WHERE ([filmTuru] = 'default')"></asp:SqlDataSource>
            <asp:Repeater ID="DefaultRepeater" runat="server" DataSourceID="DefaultSqlDataSource">
                <ItemTemplate>
                    <div class="ic_bolme">
                       ...
                       <FooterTemplate>
                           <asp:Label ID="lblfilm" runat="server" CssClass="filmYok" Text  ="Aradığınız Film Bulunamadı Sitede Görmek İstediğiniz Filmi İletişim Kısmından İletiniz" Visible="<%#DefaultRepeater.Items.Count==0 %>"></asp:Label>
                       </FooterTemplate>
    ...
    <div class="sag">
        <div class="filmlerTasiyici">
            <div class="kategori">
                ...
                <p>                 
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                 
                <asp:TextBox ID="txtArama"  runat="server"  CssClass="textBoxlar aramaText" Height="25px" Width="127px" OnTextChanged="txtArama_TextChanged"></asp:TextBox> <br /><br />
