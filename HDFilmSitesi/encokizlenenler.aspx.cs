...
public partial class encokizlenenler : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Request.QueryString["altKat"] != null)
        {
            ...
            EncokizlenenlerSqlDataSource.SelectCommand =
              "SELECT  * FROM [Filmler] WHERE ([filmTuru] = 'encokizlenen' and [altKategoriId]=" + gelenKategoriId + ")";
        }
    }
    ...
    {
        string aramaCümlesi = "Select * from [Filmler] where ([filmTuru]='encokizlenen' and [filmAd] like '%" + Aranan + "%')";
        EncokizlenenlerSqlDataSource.SelectCommand = aramaCümlesi;
