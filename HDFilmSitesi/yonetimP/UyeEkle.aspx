<%@ Page Title="" Language="C#" MasterPageFile="~/yonetimP/yonetimP.master" AutoEventWireup="true" CodeFile="UyeEkle.aspx.cs" Inherits="yonetimP_UyeEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Yonetimicerik" Runat="Server">
     <h3 class="yonetimbasliklar">ÜYE EKLE</h3>
    <div class="tablo">
