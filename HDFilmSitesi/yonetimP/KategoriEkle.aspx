<%@ Page Title="" Language="C#" MasterPageFile="~/yonetimP/yonetimP.master" AutoEventWireup="true" CodeFile="KategoriEkle.aspx.cs" Inherits="yonetimP_KategoriEkle" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
       .tablostill {
         ...
         tr,td{padding:7px;}
         td{font-size:large; font-family: 5px 10px Calibri; padding-left:30px; font-size:14px;}
         .txt{font-family:Arial; font-size:large; padding:2px 4px; margin:0px 10px; width:90%; }
        
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Yonetimicerik" Runat="Server">
       <h3 class="yonetimbasliklar">Ana Kategori Ekle</h3>
       <div class="tablo">    
       <table align="center" class="tablostill">
            
        <tr>
            <td style="width:90px;">Kategori Adı :</td>
            <td><asp:TextBox ID="txtKategoriAdi" runat="server" Height="25px"></asp:TextBox></td>        
        </tr>
