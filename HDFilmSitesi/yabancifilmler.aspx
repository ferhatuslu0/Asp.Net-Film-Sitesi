<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="yabancifilmler.aspx.cs" Inherits="yabancifilmler" %>
   ...
   <div class="menuler">
    ...
    <div id="orta">
        <div class="filmTasiyici">
            ...
            <asp:SqlDataSource ID="yabanciFilmlerSqlDataSource" runat="server"
                ConnectionString="<%$ ConnectionStrings:BaglamaCumlesi %>"
                ProviderName="<%$ ConnectionStrings:BaglamaCumlesi.ProviderName %>"
                SelectCommand="SELECT [filmId], [filmAd], [filmBilgi], [FilmUrl], [altKategoriId], [filmTuru] FROM [Filmler] WHERE ([filmTuru] = 'yabanci') ORDER BY [filmId] DESC">
                
            </asp:SqlDataSource>
            <asp:Repeater ID="yabanciFilmlerRepeater" runat="server" DataSourceID="yabanciFilmlerSqlDataSource">
                <ItemTemplate>
                    <div class="ic_bolme">
                ...
                <FooterTemplate>
                   <asp:Label ID="lblfilm" runat="server" CssClass="filmYok" Text  ="Aradığınız Film Bulunamadı Sitede Görmek İstediğiniz Filmi İletişim Kısmından İletiniz" Visible="<%#yabanciFilmlerRepeater.Items.Count==0 %>"></asp:Label>
                 </FooterTemplate>
